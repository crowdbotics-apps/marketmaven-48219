"""
Django settings for marketmaven_48219 project.
...
ROOT_URLCONF = 'marketmaven_48219.urls'
...
WSGI_APPLICATION = 'marketmaven_48219.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "marketmaven_48219 API",
    "DESCRIPTION": "API documentation for marketmaven_48219 App",
    "VERSION": "v1",
}
